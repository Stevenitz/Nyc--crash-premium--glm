...
# Read the CSV file and parse the 'Month' column as dates
...
# Keep ONLY the columns you were using before
keep_columns = [
    'CRASH DATE',
    'CRASH TIME', 
    'BOROUGH',
...
# Use ALL complete years (2012-2024, exclude partial 2025-2026)
...
# Then create daily injuries from filtered data
...
# Since you don't have injury severity breakdown, use weighted average
# Based on your data pattern: mostly minor, some serious, few fatalities
